...
class App extends Component {
   ...
   initMap = () => {
      ...
      var map = new window.google.maps.Map(document.getElementById('map'), {
         ...
         // center: {lat: myVenue.venue.location.lat, lng: myVenue.venue.location.lng },
      ...
      this.state.venues.map(myVenue => {
         ...
         let items   = document.getElementsByClassName('venueItem')
         let myItems = document.getElementById('venueList')
         let myItem  = document.getElementById('venueList').innerText
   ...
   //    let item, k = 0
   //
   //    document.getElementById('venueList').addEventListener('click', function (e) {
   //       for (k = 0; k < 30; k++) {
   //          let itemsK = document.getElementById('venueList').childNodes
   //          let myTarget = e.target.innerHTML
   //          let myItem = itemsK[k].innerHTML
   //          console.log(e.target.innerHTML)
   //          console.log(itemsK[k].innerHTML)
   //          console.log(' ')
   //
   //          if (myTarget && myTarget.match(myItem)) { //
   //
   //             window.google.maps.event.trigger(marker, 'click')
   //             //console.log("e.target", e.target.matches("li.venueItem") )
   ...
   // handleMyClick(k) {
   //    window.google.maps.event.trigger(marker[k], 'click')
   // }
